# ============================================================
# fedavg_ucfcrime_resnet50_wandb.py
...
#
# Run:
# python fedavg_ucfcrime_resnet50_wandb.py \
...
#   --wandb_project ucfcrime-fedavg --wandb_run_name fedavg_r50_iid
#
...
# -----------------------------
def parse_args():
    p = argparse.ArgumentParser("FedAvg on UCF-Crime frames (ResNet-50) + W&B")
...
def build_loaders(args):
    ...
    # Optional: show class distribution AFTER clipping
...
def main():
    ...
    print(f"Client sizes (IID, clipped pool): {client_sizes}")
